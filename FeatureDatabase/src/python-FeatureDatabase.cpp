...
BOOST_PYTHON_MODULE(FeatureDatabase)
{
    class_<FeatureDatabase>("FeatureDatabase")
		...
		.def("calculateItem", & FeatureDatabase::calculateItem)
...
Python_FeatureDatabase::Python_FeatureDatabase()
{
	import_array();
	db = FeatureDatabase();
}

Python_FeatureDatabase::Python_FeatureDatabase(const string& config)
{
	import_array();
	db = FeatureDatabase();
...
void Python_FeatureDatabase::loadConfig(const string& config)
{
	db.loadConfig(config);
}
